...
BATCH_FOLDER = "EcoBatch"

# Resume configuration (for power outage recovery)
START_FROM_EXPERIMENT = 12  # Change this to resume from specific experiment (e.g., 40)
...
for experiment_id, experiment_vector in enumerate(design_matrix):
    ...
    try:
        ...
        # Verify hydroData will be created (function now creates it at start)
        ...
        # Verify hydroData folder was created
...
print(f"   2. Use hydrodynamic coefficients for RAO/power calculations")
print(f"   3. Build response surface model")
print(f"   4. Perform optimization")
