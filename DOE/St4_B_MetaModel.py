...
# Input configuration
VECTOR_DATA_FILE = "EcoData/MetaModel/VectorValues.pkl"

# Output configuration
OUTPUT_FOLDER = "EcoData/MetaModel/Analysis"
PLOTS_FOLDER = "EcoData/MetaModel/Plots"
