...
# Input configuration
BATCH_FOLDER = "EcoData/St2_EcoBatch"  # Folder containing DOE experiments (CORRECTED PATH)
DOE_FILE = "EcoData/St1_DOEvalues/DOE_values.pkl"  # DOE design file
RAO_FOLDER = "EcoData/St3_RAO"  # Folder with RAO results

# Output configuration
OUTPUT_FOLDER = "EcoData/St3_Power"  # Output folder for Power results
